<%@ Page Title="Ventas" Language="vb" AutoEventWireup="false" MasterPageFile="~/Mersol.Master" CodeBehind="computo_celular.aspx.vb" Inherits="Mersol.computo_celular" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Consulta Linea Celulares</h4>
