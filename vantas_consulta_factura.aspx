<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Mersol.Master" CodeBehind="vantas_consulta_factura.aspx.vb" Inherits="Mersol.vantas_consulta_factura" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Consultar Serie de Factura</h4>
                                ...
                                <div class="mt-md-0 d-flex">
                                    <div class="m-1">
                                        <select id="sltSistema" class="form-select sltSistema" runat="server">
                                            ...
                                            <option value="1">Intelisis</option>
                                            <option value="2">Comercial</option>
                                        </select>
                                    </div>

                                    <div class="col-auto m-1">
                                        <input type="text" class="form-control" id="txtFactura" runat="server" placeholder="No. Factura" />
                                    </div>
        ...
        <div class="container row">
            <div class="table small">
                <asp:GridView runat="server" ID="gvfactura" autogeneratecolumns="True" CssClass="table table-striped table-bordered dt-responsive nowrap dtHorizontalExampleWrapper" width="100%">
