<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Mersol.Master" CodeBehind="computo_detalle.aspx.vb" Inherits="Mersol.computo_detalle" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between">
                                <div class="col-md-9">
                                    <h4 class="mt-0 header-title">DETALLE INVENTARIO DE COMPUTO MERCADO DE LA SOLDADURA DEL SURESTE</h4>
                        ...
                        <div class="card-body">
                            <div class="container row">
                                <div class="table small">
                                    <asp:GridView runat="server" ID="gvdetalle" autogeneratecolumns="False" CssClass="table table-striped table-bordered dt-responsive nowrap dtHorizontalExampleWrapper" width="100%">
                                        <Columns>
                                            <asp:BoundField DataField="Id_Activo" HeaderText="ID ACTIVO" /> 
                                            ...
                                            <asp:BoundField DataField="Expr1" HeaderText="COMPONENTE" />
                                            <asp:BoundField DataField="Expr2" HeaderText="SERIE FABRICANTE" />
                                            <asp:BoundField DataField="Valor_Activo" HeaderText="Valor Activo" />
