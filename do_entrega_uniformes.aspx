<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Mersol.Master" CodeBehind="do_entrega_uniformes.aspx.vb" Inherits="Mersol.do_entrega_uniformes" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Reporte Entrega de Uniformes</h4>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mt-md-0 d-flex">
                                    <div class="col-auto m-2">
                                        <input type="text" id="txtBusqueda" class="form-control" placeholder="Ingrese término de búsqueda" oninput="buscar()"/>
                                    </div>
                                </div>
                            </div><!-- end col-->
                        </div> <!-- end row -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvUniformes" autogeneratecolumns="True" CssClass="table table-striped table-bordered dt-responsive nowrap dtHorizontalExampleWrapper" width="100%">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script>
        ...
        function buscar() {
            ...
            var gridView = document.getElementById('<%= gvUniformes.ClientID %>');
