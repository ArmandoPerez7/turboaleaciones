<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Mersol.Master" CodeBehind="do_asisfxdia.aspx.vb" Inherits="Mersol.do_asisfxdia" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Reporte de Faltas por Día</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="container row mt-2">
                            <div class="table small">
                                <asp:GridView runat="server" ID="gvasisfxdia" CssClass="table table-striped table-bordered dt-responsive nowrap dtHorizontalExampleWrapper" width="100%">
