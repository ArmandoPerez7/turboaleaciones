<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Mersol.Master" CodeBehind="usuarios_lista.aspx.vb" Inherits="Mersol.usuarios_lista" %>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mt-md-0 d-flex">
                                    <div class="col-auto m-1">
                                        <input type="text" class="form-control date" data-provide="datepicker" id="txtFecha" runat="server" placeholder="Fecha inicio" />
                                    </div>
